...
(function() {
    function C() {
        if (!D && document.body) {
            ...
            if (top != self) u = !0;
                ...
                A = new Z(v);
                A.observe(a, { attributes: !0, childList: !0, characterData: !1 });
    ...
    function K(a, b, d) {
        ...
        if (!F) {
            var e = a === document.body,
                h = function(c) {
                    c = Date.now();
                    for (var g = 0, k = 0, l = 0; l < t.length; l++) { var n = t[l],
                            p = c - n.start,
                            m = p >= f.animationTime,
    ...
    function N(a) {
        ...
        b = O(b);
        if (!b) return u && G ? (Object.defineProperty(a, "target", { value: window.frameElement }), a = new a.constructor(a.type, a), parent.dispatchEvent(a)) : !0;
    ...
    function J(a) {
        ...
        if (!(c = a.defaultPrevented || c.test(b.nodeName) || r(b, "input") && !e.test(b.type) || r(m, "video"))) { var c = a.target,
                g = !1; if (-1 != document.URL.indexOf("www.youtube.com/watch")) { do
                    if (g = c.classList && c.classList.contains("html5-video-controls")) break; while (c = c.parentNode) } c = g }
    ...
    function Q(a) { m = a.target }

    function P() { clearTimeout(R);
        R = setInterval(function() { H = {} }, 1E3) }

    function I(a, b) { for (var d = a.length; d--;) H[S(a[d])] = b; return b }

    function O(a) { var b = [],
            d = document.body,
            c = k.scrollHeight;
        do { var e = H[S(a)]; if (e) return I(b, e);
            b.push(a); if (c === a.scrollHeight) { if (e = T(k) && T(d) || U(k), u && k.clientHeight + 10 < k.scrollHeight || !u && e) return I(b, ea()) } else if (a.clientHeight + 10 < a.scrollHeight && U(a)) return I(b, a) } while (a = a.parentElement) }
    ...
    function U(a) { a = getComputedStyle(a, "").getPropertyValue("overflow-y"); return "scroll" === a || "auto" === a }

    function r(a, b) { return (a.nodeName || "").toLowerCase() === b.toLowerCase() }

    function aa(a, b) { a = 0 < a ? 1 : -1;
        b = 0 < b ? 1 : -1; if (B.x !== a || B.y !== b) B.x = a, B.y = b, t = [], E = 0 }

    function ca(a) { if (a) return l.length || (l = [a, a, a]), a = Math.abs(a), l.push(a), l.shift(), clearTimeout(V), V = setTimeout(function() { try { localStorage.SS_deltaBuffer = l.join(",") } catch (a) {} }, 1E3), !W(120) && !W(100) }

    function w(a, b) { return Math.floor(a / b) == a / b }

    function W(a) { return w(l[0], a) && w(l[1], a) && w(l[2], a) }

    function L(a) { var b;
        a *= f.pulseScale;
        1 > a ? b = a - (1 - Math.exp(-a)) : (b = Math.exp(-1), --a, a = 1 - Math.exp(-a), b += a * (1 - b)); return b * f.pulseNormalize }

    function x(a) { for (var b in a) X.hasOwnProperty(b) && (f[b] = a[b]) }
    var X = {
            frameRate: 150,
            animationTime: 400,
            stepSize: 100,
        ...
        da = { 37: 1, 38: 1, 39: 1, 40: 1 },
        t = [],
        F = !1,
        E = Date.now(),
        S = function() { var a = 0; return function(b) { return b.uniqueID || (b.uniqueID = a++) } }(),
        H = {},
        R, V;
    if (window.localStorage && localStorage.SS_deltaBuffer) try { l = localStorage.SS_deltaBuffer.split(",") } catch (ha) {}
    var M = function() {
        ...
        ea = function() { var a; return function() { if (!a) { var b = document.createElement("div");
    ...
    "function" === typeof define && define.amd ? define(function() { return x }) : "object" == typeof exports ? module.exports = x : window.SmoothScroll = x
})();